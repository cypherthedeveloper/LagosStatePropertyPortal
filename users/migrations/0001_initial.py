    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('government', 'Government Agency'), ('real_estate_firm', 'Real Estate Firm'), ('property_owner', 'Property Owner'), ('buyer_renter', 'Buyer/Renter')], default='buyer_renter', max_length=20)),
                ...
                ('business_document', models.FileField(blank=True, null=True, upload_to='business_documents/')),
